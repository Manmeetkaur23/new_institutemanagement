...
/********news and event ******** */
if(!empty($_POST['action']) && $_POST['action'] == 'listNewsEvents') {
	$school->listNewsEvents();
}
if(!empty($_POST['action']) && $_POST['action'] == 'addNewsEvents') {
	$school->addNewsEvents();
}
if(!empty($_POST['action']) && $_POST['action'] == 'getNewsEvents') {
	$school->getNewsEvents();
}
if(!empty($_POST['action']) && $_POST['action'] == 'updateNewsEvents') {
	$school->updateNewsEvents();
}
if(!empty($_POST['action']) && $_POST['action'] == 'deleteNewsEvents') {
	$school->deleteNewsEvents();
}
?>